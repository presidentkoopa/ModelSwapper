...
#
# NOTE: no longer emits PlacementCVars -- the ms_pu_* sliders went with the
# floor-pickup feature, and an unknown MODELDEF property is a FATAL parse
# error on stock GZDoom rather than something it skips.
#
